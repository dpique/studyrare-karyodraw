...
(function (root) {
  var CONTENT = [
    ...
    { slug: "translocation-down-syndrome", k: "46,XX,der(14;21)(q10;q10),+21", name: "Translocation Down syndrome", aka: ["translocation trisomy 21", "der(14;21) trisomy 21", "familial Down syndrome"],
      concept: "Unbalanced derivative", tour: false,
      intro: "46,XX,der(14;21)(q10;q10),+21 is Down syndrome caused by an unbalanced Robertsonian translocation: the count stays at 46, but the der(14;21) plus a free chromosome 21 add up to three copies of 21q. When a parent carries the balanced rob(14;21), the recurrence risk is far higher than after free trisomy 21, which is why the distinction matters for counseling.",
      related: ["robertsonian-translocation-14-21", "down-syndrome", "emanuel-syndrome"] },
    { slug: "emanuel-syndrome", k: "47,XX,+der(22)t(11;22)(q23;q11.2)", name: "Emanuel syndrome", aka: ["supernumerary der(22)", "der(22) syndrome", "t(11;22) syndrome"],
      concept: "Unbalanced derivative", tour: false,
      intro: "47,XX,+der(22)t(11;22)(q23;q11.2) is Emanuel syndrome: an extra derivative chromosome 22 made of the exchanged pieces of the recurrent t(11;22). The supernumerary der(22) usually arises through 3:1 segregation in a parent who carries the balanced translocation.",
      related: ["t-11-22-carrier", "translocation-down-syndrome", "philadelphia-chromosome"] },
    ...
    { slug: "isodicentric-y", k: "46,X,idic(Y)(q11.2)", name: "Isodicentric Y chromosome", aka: ["idic(Y)", "isodicentric Yq11.2", "dicentric Y"],
      concept: "Dicentric chromosome", tour: false,
      ...
      related: ["turner-syndrome", "mosaic-turner-syndrome", "isochromosome-xq"] },
    ...
    { slug: "insertion-2-5", k: "46,XY,ins(2;5)(q14.2;q22q31)", name: "Direct insertion ins(2;5)", aka: ["insertion", "ins(2;5)", "interchromosomal insertion"],
      concept: "Insertion", tour: false,
      intro: "46,XY,ins(2;5)(q14.2;q22q31) is a direct interchromosomal insertion: the segment of chromosome 5 between bands 5q22 and 5q31 is removed and inserted into chromosome 2 at band 2q14.2. The carrier is balanced, but the inserted segment can segregate on its own, so a child can inherit a pure duplication or a pure deletion of 5q22-q31.",
      related: ["chromosome-1q-duplication", "cri-du-chat-syndrome", "translocation-down-syndrome"] },
    ...
    { slug: "ewing-sarcoma", k: "46,XY,t(11;22)(q24;q12)", name: "Ewing sarcoma t(11;22)", aka: ["EWSR1-FLI1", "t(11;22)", "Ewing family tumor"],
      concept: "Cancer cytogenetics", tour: false,
      intro: "46,XY,t(11;22)(q24;q12) is the defining translocation of Ewing sarcoma, fusing <i>EWSR1</i> on chromosome 22 with <i>FLI1</i> on chromosome 11. It accounts for most cases, and the fusion is what separates Ewing sarcoma from the other small round blue cell tumors of childhood.",
      related: ["desmoplastic-small-round-cell-tumor", "childhood-all-t-12-21", "philadelphia-chromosome"] },
    { slug: "desmoplastic-small-round-cell-tumor", k: "46,XX,t(11;22)(p13;q12)", name: "Desmoplastic small round cell tumor t(11;22)", aka: ["DSRCT", "EWSR1-WT1", "t(11;22)"],
      concept: "Cancer cytogenetics", tour: false,
      intro: "46,XX,t(11;22)(p13;q12) is the translocation of desmoplastic small round cell tumor, fusing <i>EWSR1</i> with <i>WT1</i>. It involves the same two chromosomes as Ewing sarcoma but a different arm of chromosome 11: q24 is Ewing, p13 is DSRCT, and the breakpoints are the only way to tell the two apart.",
      related: ["ewing-sarcoma", "nut-carcinoma", "burkitt-lymphoma"] },
    { slug: "nut-carcinoma", k: "46,XY,t(15;19)(q14;p13.1)", name: "NUT carcinoma t(15;19)", aka: ["BRD4-NUTM1", "NUT midline carcinoma", "t(15;19)"],
      concept: "Cancer cytogenetics", tour: false,
      intro: "46,XY,t(15;19)(q14;p13.1) is the translocation of NUT carcinoma, fusing <i>BRD4</i> with <i>NUTM1</i>. It defines an aggressive midline carcinoma of children and young adults, and it is one of the few carcinomas simple enough for the karyotype itself to be diagnostic.",
      related: ["ewing-sarcoma", "eml4-alk-lung-cancer", "acute-promyelocytic-leukemia"] },
    { slug: "eml4-alk-lung-cancer", k: "46,XY,inv(2)(p21p23)", name: "EML4-ALK lung cancer inv(2)", aka: ["EML4-ALK", "ALK-positive lung cancer", "ALK rearrangement", "inv(2)"],
      concept: "Cancer cytogenetics", tour: false,
      intro: "46,XY,inv(2)(p21p23) is the paracentric inversion behind ALK-positive lung cancer, fusing <i>EML4</i> with <i>ALK</i> within the short arm of chromosome 2. Typically found in younger patients and never or light smokers, it is the target of crizotinib and the ALK inhibitors that followed.",
      resolution: "The inversion within 2p is far too small to see with banding, so ALK-positive lung cancer is diagnosed by FISH, immunohistochemistry or sequencing rather than by a karyotype.",
      related: ["philadelphia-chromosome", "nut-carcinoma", "childhood-all-t-12-21"] },
    ...
    { slug: "t-11-22-carrier", k: "46,XX,t(11;22)(q23;q11.2)", name: "Balanced t(11;22) carrier", aka: ["t(11;22)", "constitutional t(11;22)", "Emanuel syndrome carrier"],
      concept: "Reciprocal translocation", tour: false,
      intro: "46,XX,t(11;22)(q23;q11.2) is the most common recurrent constitutional reciprocal translocation in humans. The carrier is balanced and healthy; the reproductive risk is a 3:1 segregation that passes the small der(22) on as an extra chromosome, producing Emanuel syndrome.",
      related: ["emanuel-syndrome", "philadelphia-chromosome", "robertsonian-translocation-14-21"] },
    { slug: "x-autosome-translocation-manifesting-carrier", k: "46,X,t(X;4)(p21;p16)", name: "X-autosome translocation, manifesting female carrier",
      aka: ["t(X;4)", "X;autosome translocation", "manifesting carrier", "skewed X inactivation", "Duchenne in a girl"],
      concept: "Reciprocal translocation", tour: false,
      intro: "46,X,t(X;4)(p21;p16) is balanced, yet the carrier is affected. In a balanced X-autosome carrier the <em>normal</em> X is the one silenced, because silencing the derivative would spread inactivation into the attached chromosome 4 material. That leaves the der(X) as her only active X, so the dystrophin gene broken at the Xp21 breakpoint has no working copy behind it, and she presents with a muscular dystrophy that is otherwise almost exclusive to boys. Translocations like this one are how several X-linked genes were first mapped.",
      related: ["t-11-22-carrier", "isochromosome-xq", "turner-syndrome", "philadelphia-chromosome"] },
    { slug: "pallister-killian-syndrome", k: "mos 47,XX,+i(12)(p10)/46,XX", name: "Pallister-Killian syndrome", aka: ["mosaic tetrasomy 12p", "isochromosome 12p", "i(12p)"],
      concept: "Mosaicism", tour: false,
      intro: "mos 47,XX,+i(12)(p10)/46,XX is Pallister-Killian syndrome: a supernumerary isochromosome of 12p present in only some cells, giving mosaic tetrasomy 12p. The extra chromosome is typically absent from blood lymphocytes, so the diagnosis classically requires a skin fibroblast karyotype or a microarray.",
      related: ["mosaic-turner-syndrome", "isochromosome-xq", "marker-chromosome"] },
    { slug: "monosomy-7-mds", k: "45,XX,-7", name: "Monosomy 7 (MDS/AML)", aka: ["-7", "monosomy 7"],
      concept: "Cancer cytogenetics", tour: false,
      intro: "45,XX,-7 is an acquired monosomy: one whole copy of chromosome 7 is lost in the malignant cells. Monosomy 7 is among the most common cytogenetic abnormalities in myelodysplastic syndrome and acute myeloid leukemia and carries an unfavorable prognosis.",
      related: ["mds-5q-deletion", "aml-inv-16", "aml-t-8-21"] },
    { slug: "tetraploidy", k: "92,XXXX", name: "Tetraploidy", aka: ["92 XXXX", "tetraploid"],
      concept: "Polyploidy", tour: false,
      intro: "92,XXXX is tetraploidy: four complete chromosome sets instead of two, most often from a failed first division of the zygote. It is rarely compatible with ongoing pregnancy and is mainly seen in early pregnancy loss; in a report it must also be distinguished from a tetraploid artifact of cell culture.",
      related: ["triploidy", "normal-female-karyotype", "mosaic-turner-syndrome"] }
  ];
