...
export const CORPUS = [
  ...
  { k: '46,XY,t(3;3)(q21.3;q26.2)', group: 'cancer', expect: 'draw', why: 'The canonical MECOM rearrangement of AML, refused until 2026-08-29 by a rule sentence the standard contradicts.', watch: 'Draws two derivative 3s; decode names the homologous exchange.' },
