...
export const CORPUS = [
  ...
  { k: '45,XY,der(5;7)t(3;5)(q21;q22)t(3;11)(q29;q13)t(11;12)(q23;q13)t(7;12)(p13;q24.1)', group: 'struct', expect: 'draw', why: 'ISCN 5.5.3 c ii extended by two more joins, the shape a complex-karyotype report actually prints: a dicentric der(5;7) chaining 5 to 3 to 11 to 12 to 7.', watch: 'TWO centromeres, one on the 5 piece and one on the 7 piece, and all five chromosomes present in chain order. The walk once stopped after eight steps, so long chains are the case to watch.' },
  { k: '45,XX,der(8;8)(q10;q10)del(8)(q22)t(8;9)(q24.1;q12)', group: 'struct', expect: 'draw', why: 'ISCN 5.5.3 c iv verbatim: the two long arms of chromosome 8 fused at the centromeres, one truncated at q22, chromosome 9 material on the other at q24.1.', watch: 'The body is 8q against 8q with NO 8p anywhere, one arm visibly shorter (the deletion), the 9 graft on the other. This used to draw an intact 8p and one centromere.' },
  { k: '45,XX,der(13;14)(q10;q10)t(9;14)(q22;q24)', group: 'struct', expect: 'draw', why: 'A Robertsonian body carrying a further translocation: 13q and 14q fused, with 9q22→qter on the 14q arm at q24.', watch: 'Both the 13q and 14q arms present with the 9 graft riding the 14 arm. This used to draw a der(9) figure with chromosome 13 nowhere on it.' },
  { k: '45,XY,der(5;7)t(3;5)(q21;q22)t(3;11)(q29;q13)', group: 'typo', expect: 'refuse', why: 'A der(5;7) whose joins never reach chromosome 7, the transcription slip of dropping the final join from a chain.', watch: 'Refused with the chain rule stated. This used to draw a ONE-centromere figure under a caption that names a dicentric, with no warning.' },
  { k: '45,XY,t(3;5)(q21;q22)t(3;11)(q29;q13)t(11;12)(q23;q13)t(12;17)(q24.1;q11.2)t(7;17)(p13;q21)', group: 'typo', expect: 'refuse', why: 'A der() chain with the der(...) head dropped: run-together t() groups that no operation owns. The commonest way to mistype the complex-karyotype chain.', watch: 'The message must teach BOTH readings: put der() in front for one derivative (count 45), or commas between the groups for independent translocations (count 46). The generic "changes look like +21" message here taught neither.' },
  { k: '46,XY,der(3)t(3;5)(q21;q22)t(3;11)(q29;q13)t(11;12)(q23;q13)t(12;17)(q24.1;q11.2)t(7;17)(p13;q21)', group: 'typo', expect: 'refuse', why: 'The dicentric chain misnamed der(3): after t(3;5) cuts 3 at q21, the join at 3q29 names material this der(3) no longer carries. Typed by Dan while exploring the der(5;7) version.', watch: 'Refused, teaching that each of der(3)’s own arms takes one junction and that the run-on chain is the der(A;B) form. It used to draw the first join, drop the other four in silence, and decode all five.' },
  { k: '47,XX,+der(22),t(11;22)(q23.3;q11.2)', group: 'struct', expect: 'draw', why: 'The Emanuel-type supernumerary der(22), typed der-first the way reports write it: +der(22) alone means the derivative of the t(11;22) listed beside it (ISCN 4.2.1 f). A visitor flagged it.', watch: 'The extra der(22) must be the SMALL chromosome (22pter to q11.2 plus the 11q tip), not an intact 22. It drew an intact 22 under a der caption until the 2026-08-28 review.' },
  { k: '46,XX,t(9;22)(q34;q11.2)[10]/47,XX,t(9;22),+der(22)[10]', group: 'cancer', expect: 'draw', why: 'ISCN 4.2.1 f verbatim: clonal evolution gaining a second Philadelphia, written with the bare back-references the standard prints.', watch: 'Clone 2 carries THREE derivative chromosomes: der(9), der(22), and the supernumerary der(22), all with the t(9;22) composition.' },
  { k: '46,XX,der(9)del(p21)t(9;22)(q34;q11.2)', group: 'unusual', expect: 'draw', why: 'Mitelman-style shorthand putting the band where the chromosome goes: del(p21) on a der(9) means del(9)(p21).', watch: 'Draws with the spelling taught (del(9)(p21)); the der(9) must be MISSING 9pter to p21. The deletion was dropped in silence until the 2026-08-28 review.' },
  { k: '46,XY,add(4)(q31.3)x2', group: 'unusual', expect: 'draw', why: 'A multiplier on an unsigned structural abnormality: both chromosome 4 homologs carry the added material.', watch: 'TWO add(4) chromosomes and zero normal 4s. The second copy was dropped in silence until the 2026-08-28 review.' },
  { k: '46,XY,der(2)ins(2;7)(p?21;q21.3q22.1)inv(2)(p21q14),der(7)ins(2;7)', group: 'notdrawn', expect: 'refuse', why: 'An undetermined insertion site (p?21) is correct ISCN 4.2.1 k, and with the site unknown there is nothing honest to draw.', watch: 'Refused with the question-mark teaching. It used to DRAW with the whole insertion silently dropped while the decode still described the chromosome 7 transfer.' },
  { k: '76~77,XX,-Y,+1,+2,-3,+4,add(4)(q31.3)x2,+5,+6,+7,+8,der(8)t(8;14)(q21.2;q13)t(11;14)(q13;q32)x2,+add(9)(p21),+10,add(10)(q22),der(11)t(11;14)(q13;q32)x2,-12,-13,+16,+17,der(17)t(12;17)(q11;p13)x2,+18,+19,-20,-21,+22[cp3]', group: 'cancer', expect: 'draw', why: 'A near-triploid composite lymphoma clone from production: the count reconciles only against 3n=69, with no <3n> stated.', watch: 'The scaffold must be triploid (chromosome 1 drawn four times, not three) and the count row must explain the inferred baseline. It drew on a diploid scaffold, roughly 25 chromosomes short, until the 2026-08-28 review.' },
  { k: '58<2n>,XY,+X,+4,+6,+8,+9,+10,+14,+14,+17,+18,+21,+21', group: 'cancer', expect: 'draw', why: 'Hyperdiploid ALL with a stated <2n>: the count is far from 46 and the qualifier says to score against the diploid baseline anyway.', watch: 'The +X gloss must not say trisomy X (an XY cell gaining an X has two X); +14,+14 and +21,+21 are tetrasomies; the count row must explain <2n>.' },
  { k: '45,XY,der(5;7)t(3;5)(q21;q22)t(3;7)(q29;p13)t(9;11)(q22;q13)', group: 'typo', expect: 'refuse', why: 'A join belonging to some other line pasted into a der() chain: t(9;11) shares no junction with the 5-3-7 chain.', watch: 'Refused, naming t(9;11)(q22;q13) as the join that does not connect. It used to vanish from the figure in silence.' },
  ...
  // The failure-tail message audit (2026-08-29), pinned as permanent cards.
  { k: 'arr[GRCh37]9p24.3(203862_601901)x3', group: 'typo', expect: 'refuse', why: 'Microarray nomenclature pasted whole. It used to get ten bullets scolding underscores that are valid in arr coordinates.', watch: 'ONE message naming the platform and the banded equivalent. No character-by-character shredding.' },
  { k: '47,XX,der(22)t(11;22)(q23;q11.2)', group: 'typo', expect: 'refuse', why: 'Emanuel syndrome missing its +. The count-lowering chip alone used to steer away from the typed 47.', watch: 'BOTH readings on chips: 46 with the der as a replacement, and 47,XX,+der(22)t(11;22)(q23;q11.2), the syndrome that was meant.' },
  { k: '47,XX+mar', group: 'typo', expect: 'refuse', why: 'A marker glued to the sex field. The old repair amputated it and offered plain 47,XX.', watch: 'The chip is 47,XX,+mar, comma restored, marker kept.' },
  { k: '45,XO[39]/46,XY[61]', group: 'typo', expect: 'refuse', why: 'The old XO shorthand for Turner mosaicism, from a real report.', watch: 'Taught that ISCN writes the lone X alone, with 45,X[39]/46,XY[61] on a chip.' },
  { k: '46,XY,t', group: 'typo', expect: 'refuse', why: 'A bare op name, the single commonest template in the failure tail (16 inputs).', watch: 'The op’s OWN lesson with its full form as the example, not "not a change KaryoDraw recognizes" about a word the app lists as one it draws.' },
  ...
  { k: '46,XY,t(9;9)(q34;q11)', group: 'unusual', expect: 'draw', why: 'A translocation between the two HOMOLOGS of chromosome 9, accepted since 2026-08-29: ISCN prints homologous exchanges (der(1)t(1;1)(p31;q32), t(2;7;7)), and the old refusal turned away t(3;3)(q21.3;q26.2), the MECOM rearrangement of AML.', watch: 'Two different derivative 9s beside no normal 9. The decode says homologous; the segregation and pachytene panels stay ABSENT (their quadrivalent story does not apply to homologs).' },
  { k: '46,XY,t(3;3)(q21.3;q26.2)', group: 'cancer', expect: 'draw', why: 'The canonical MECOM rearrangement of AML, refused until 2026-08-29 by a rule sentence the standard contradicts.', watch: 'Draws two derivative 3s; decode names the homologous exchange. Both breaks are on q, so one derivative deletes the interval between them and the other duplicates it. They must not match.' },
  { k: '46,XX,t(16;16)(p13;q22)', group: 'cancer', expect: 'draw', why: 'The CBFB::MYH11 rearrangement of AML M4Eo, and the karyotype a reader wrote in about on 2026-09-08: both derivative 16s were drawn as the same chromosome, which also made the segment dosage read 0 copies of 16pter-p13 and 4 of 16q22-qter for a balanced exchange.', watch: 'Two DIFFERENT derivative 16s beside no normal 16: one is 16qter-16q22::16p13-16qter, the other 16pter-16q22::16p13-16pter. Segment dosage reads two copies on all three rows.' },
