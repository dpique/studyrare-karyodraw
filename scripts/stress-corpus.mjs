...
export const CORPUS = [
  ...
  { k: '46,XY,del(5)(p15.3p15.2)', group: 'hole', expect: 'refuse', why: 'Known hole. Breakpoints given from telomere toward centromere; ISCN orders them centromere first.', watch: 'Currently draws. Does the deleted segment at least come out the same either way?' },
  ...
  { k: '46,XY,del(5)(p15.2),del(5)(p15.2)', group: 'hole', expect: 'refuse', why: 'Known hole. The same deletion listed twice; ISCN writes del(5)(p15.2)x2 if both homologs are deleted.', watch: 'Currently draws. Which homolog gets the second deletion?' },
  ...
  { k: '46<3n>,XY', group: 'hole', expect: 'refuse', why: 'Known hole. The ploidy note says triploid and the count says diploid.', watch: 'Currently draws.' },
  { k: '46c,XY', group: 'hole', expect: 'refuse', why: 'Known hole. c marks a constitutional karyotype in a tumor report and needs the tumor clone alongside it.', watch: 'Currently draws.' },
