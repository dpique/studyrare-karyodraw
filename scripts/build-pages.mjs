...
<meta property="og:title" content="${attr(e.name + ' karyotype (' + e.k + ')')}" />
<meta property="og:description" content="${attr(desc)}" />
<meta property="og:url" content="${url}" />
<meta property="og:image" content="${SITE}/preview.png" />
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="${attr(e.name + ' karyotype (' + e.k + ')')}" />
<meta name="twitter:description" content="${attr(desc)}" />
<meta name="twitter:image" content="${SITE}/preview.png" />
${favicon}
<script type="application/ld+json">${jsonLd(e)}</script>
<style>${appCss}${LANDING_CSS}</style>
</head>
<body>
<header class="lp-top">
  <a class="home" href="/" aria-label="KaryoDraw home">
    ...
    <span class="tagline">a StudyRare tool</span>
  </a>
</header>
<main class="lp-wrap">
  <nav class="lp-crumb" aria-label="Breadcrumb"><a href="/">KaryoDraw</a> &rsaquo; Karyotypes &rsaquo; ${esc(e.name)}</nav>
  <article>
    <h1>${esc(e.name)}</h1>
    ...
    ${relatedLinks(e)}
    <div class="lp-foot">
      <p><a href="/">KaryoDraw</a> is a free, browser-based karyotype visualizer for <a href="https://doi.org/10.1159/000538512" target="_blank" rel="noopener">ISCN 2024</a> notation, a <a href="https://studyrare.com" target="_blank" rel="noopener">StudyRare</a> tool. It is an educational visualizer of cytogenetic nomenclature, not a diagnostic tool.</p>
    </div>
  </article>
</main>
</body>
...
function hubHtml() {
  ...
  const ld = JSON.stringify({ '@context': 'https://schema.org', '@type': 'CollectionPage', name: 'Karyotypes explained', description: desc, url,
    isPartOf: { '@type': 'WebSite', name: 'KaryoDraw', url: SITE + '/' } });
  return `<!DOCTYPE html>
<html lang="en">
<head>
...
${fontPreconnect}
${fontStylesheet}
<title>Karyotypes explained: common ISCN examples drawn and decoded | KaryoDraw</title>
<link rel="canonical" href="${url}" />
<meta name="description" content="${attr(desc)}" />
<meta name="robots" content="index, follow" />
<meta name="theme-color" content="#5e72e4" />
...
<meta property="og:site_name" content="KaryoDraw" />
<meta property="og:title" content="Karyotypes explained | KaryoDraw" />
<meta property="og:description" content="${attr(desc)}" />
<meta property="og:url" content="${url}" />
<meta property="og:image" content="${SITE}/preview.png" />
${favicon}
<script type="application/ld+json">${ld}</script>
<style>${appCss}${LANDING_CSS}
...
<main class="lp-wrap">
  <nav class="lp-crumb" aria-label="Breadcrumb"><a href="/">KaryoDraw</a> &rsaquo; Karyotypes</nav>
  <article>
    <h1>Karyotypes, explained</h1>
    <p class="lp-intro">${esc(desc)} Every example below is drawn by KaryoDraw and decoded symbol by symbol. You can also type any karyotype into the <a href="/">interactive visualizer</a>.</p>
    ${body}
    <div class="lp-foot"><p><a href="/">KaryoDraw</a> is a free ISCN 2024 karyotype visualizer, a <a href="https://studyrare.com" target="_blank" rel="noopener">StudyRare</a> tool. It is an educational visualizer of cytogenetic nomenclature, not a diagnostic tool.</p></div>
  </article>
</main>
</body>
</html>
...
console.log(`Built ${written} landing pages, injected homepage list (${CONTENT.length} entries), wrote sitemap.xml (${urls.length} urls).`);
