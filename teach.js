...
(function () {
  ...
  var FUSIONS = [
    ...
    { chroms: ["16", "16"], bands: [["p13.3", "q24.3"]],
      ...
      disease: "Acute myeloid leukemia of infants and young children, adverse risk",
      note: "Not the core-binding-factor inv(16). Different breakpoints, different genes, opposite prognosis, and cryptic on banding, so it is found by RNA sequencing or FISH rather than by looking. Most often megakaryoblastic and in children under five without Down syndrome. The contrast with inv(16)(p13.1q22) is the reason a rearrangement has to be read at its breakpoints and not at its chromosome number." },
    { chroms: ["9", "22"], bands: [["q22", "q12"], ["q22.33", "q12.2"], ["q31", "q12"]],
      ...
      note: "A t(9;22) that is not the Philadelphia chromosome: same two chromosomes, different arms, entirely different disease. A soft-tissue sarcoma of adults, indolent over years but persistently recurring and metastasising late. Despite the name it is not cartilaginous." },
    ...
    { chroms: ["6", "11"], bands: [["q27", "q23"], ["q27", "q23.3"]],
      ...
      disease: "AML, adverse risk",
      note: "Among the worst of the <i>KMT2A</i> partners, in contrast to t(9;11), which is the reason the partner and not the 11q23 break decides the risk." },
    { chroms: ["10", "11"], bands: [["p12", "q23"], ["p12.31", "q23.3"]],
      kind: "fusion", genes: ["KMT2A", "MLLT10"],
      name: "t(10;11), KMT2A-rearranged leukemia",
      disease: "AML, and a minority of T-lymphoblastic leukemia",
      note: "Frequently produced by a cryptic insertion rather than a visible reciprocal exchange, so the karyotype can read normal at 11q23 while a break-apart probe is positive." },
    ...
    { chroms: ["2", "8"], bands: [["p12", "q24"], ["p11.2", "q24"], ["p11.2", "q24.2"]],
      ...
      note: "One of the two light-chain variants of the Burkitt translocation. <i>MYC</i> stays on chromosome 8 and the immunoglobulin kappa locus moves to it, which is the reverse direction of travel from t(8;14) and the same result." },
    { chroms: ["8", "22"], bands: [["q24", "q11.2"], ["q24.2", "q11.22"]],
      kind: "juxtaposition", genes: ["IGL", "MYC"],
      name: "t(8;22), Burkitt lymphoma, lambda variant",
      disease: "Burkitt lymphoma",
      note: "The lambda light-chain variant, and the third way to reach the same overexpressed <i>MYC</i>. Worth keeping in mind at 22q11 alongside the Philadelphia breakpoint, which sits at the same band in a different disease." },
    { chroms: ["14", "16"], bands: [["q32", "q23"], ["q32", "q23.2"]],
      kind: "juxtaposition", genes: ["IGH", "MAF"],
      name: "t(14;16), plasma cell myeloma",
      disease: "Plasma cell myeloma, high risk",
      note: "Cryptic on banding like t(4;14), so it is a FISH call on selected plasma cells. High risk in current staging, and associated with a higher rate of extramedullary and plasma cell leukemia presentations." },
    ...
    { chroms: ["21", "22"], bands: [["q22", "q12"], ["q22.2", "q12.2"]],
      ...
      note: "The commonest alternative to t(11;22), accounting for most of the remaining cases. Same disease and same treatment, which is why an <i>EWSR1</i> break-apart probe is the usual test rather than a fusion-specific one." },
    ...
    { chroms: ["1", "13"], bands: [["p36", "q14"], ["p36.13", "q14.11"]],
      ...
      disease: "Alveolar rhabdomyosarcoma",
      note: "The less common partner, and the better one: <i>PAX7</i>::<i>FOXO1</i> carries a distinctly better outlook than <i>PAX3</i>::<i>FOXO1</i>, in younger patients with more often localised disease. Which partner it is therefore belongs in the report." },
    { chroms: ["12", "15"], bands: [["p13", "q25"], ["p13.2", "q25.3"]],
      kind: "fusion", genes: ["ETV6", "NTRK3"],
      name: "t(12;15), ETV6::NTRK3 fusion",
      disease: "Infantile fibrosarcoma, congenital mesoblastic nephroma, and secretory carcinoma",
      note: "One rearrangement across tumours that have nothing else in common, in soft tissue, kidney, breast and salivary gland. Highly actionable: <i>NTRK</i> fusions respond to larotrectinib and entrectinib across tumour types, which is one of the clearest examples of treatment following the fusion rather than the organ." },
