...
(function () {
  ...
  function describeAberration(ab) {
    ...
    if (k === "der") return { text: "a DERIVATIVE chromosome der(" + c + "): a structurally rearranged chromosome, kept named by its centromere (" + c + ")" + (ab.note ? " — built as " + ab.note : ""), tag: "der" };
