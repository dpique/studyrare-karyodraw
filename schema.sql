...
-- (see worker.js visitorCode); ip is the raw address (STORE_RAW_IP is set in
-- wrangler.jsonc, Dan's decision 2026-09-11). See worker.js.
CREATE TABLE IF NOT EXISTS usage (
  ...
  ip        TEXT                -- the raw address; written when STORE_RAW_IP is "1" (it is)
);
